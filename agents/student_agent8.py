...
@register_agent("student_agent8")
class StudentAgent8(Agent):
    """
    ...
    def __init__(self):
        super(StudentAgent8, self).__init__()
        self.name = "StudentAgent8"
        self.autoplay = True
        self.dir_map = {
            "u": 0,
            "r": 1,
    ...
    def max_value(self, chess_board, my_pos, adv_pos, max_step, depth, alpha, beta):
        ...
        p = self.possibleMoves(chess_board, my_pos, adv_pos, max_step)
