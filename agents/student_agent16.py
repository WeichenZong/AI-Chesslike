...
@register_agent("student_agent16")
class StudentAgent16(Agent):
    """
    ...
    def __init__(self):
        super(StudentAgent16, self).__init__()
        self.name = "StudentAgent16"
        self.autoplay = True
        self.dir_map = {
            "u": 0,
            "r": 1,
        ...
        for i in range(1, 20):
            try:
                ...
                if best_value > -100000:
                    ...
                    print("agent 16", i, time.time() - self.start_time, self.time0, self.time1, self.time2, self.time3, self.time4)
