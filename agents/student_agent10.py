...
@register_agent("student_agent10")
class StudentAgent10(Agent):
    """
    ...
    def __init__(self):
        super(StudentAgent10, self).__init__()
        self.name = "StudentAgent10"
        self.autoplay = True
        self.dir_map = {
            "u": 0,
            "r": 1,
    ...
    def step(self, chess_board, my_pos, adv_pos, max_step):
        ...
        for i in range(1, 20):
            try:
                ...
                print("agent 10", i, time.time() - self.start_time, self.time0)
    ...
    def evaluation(self, chess_board, my_pos, adv_pos, max_step, depth):
        ...
        if depth == 0:
            return len(self.possibleMoves(chess_board, my_pos, adv_pos, max_step)) - len(self.possibleMoves(chess_board, adv_pos, my_pos, max_step))
