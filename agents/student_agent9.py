...
@register_agent("student_agent9")
class StudentAgent9(Agent):
    """
    ...
    def __init__(self):
        super(StudentAgent9, self).__init__()
        self.name = "StudentAgent9"
        self.autoplay = True
        self.dir_map = {
            "u": 0,
            "r": 1,
    ...
    def step(self, chess_board, my_pos, adv_pos, max_step):
        ...
        for i in range(1, 20):
            try:
                ...
                print("agent 9", i, time.time() - self.start_time, self.time0)
