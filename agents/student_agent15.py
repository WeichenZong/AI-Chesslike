...
@register_agent("student_agent15")
class StudentAgent15(Agent):
    """
    ...
    def __init__(self):
        super(StudentAgent15, self).__init__()
        self.name = "StudentAgent15"
        self.autoplay = True
        self.dir_map = {
            "u": 0,
            "r": 1,
    ...
    def step(self, chess_board, my_pos, adv_pos, max_step):
        ...
        for i in range(1, 20):
            try:
                ...
                print("agent 15", i, time.time() - self.start_time) #, self.time0, self.time1, self.time2, self.time3, self.time4)
    ...
    def evaluation(self, chess_board, my_pos, adv_pos, max_step, depth):
        ...
        #t = time.time()
        res, p0, p1,isConnected = self.check_endgame(chess_board, my_pos, adv_pos)
        ...
        if depth == 0:
            if( self.has4Walls(chess_board,my_pos)  ):
                return -1000
        ...
        return None
    def has4Walls(self,board,p1):
        #print(np.sum(board[p1[0],p1[1],:]))
        return np.sum(board[p1[0],p1[1],:])>=4
    def manhattan_distance(self,point1, point2):
        return abs(point1[0] - point2[0]) + abs(point1[1] - point2[1])
    def wall_continuation(self,board,p1):
        x,y =p1
    ...
    def check_endgame(self, board, p0, p1):
        ...
        return True, p0_score, p1_score,False
