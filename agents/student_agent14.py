...
@register_agent("student_agent14")
class StudentAgent14(Agent):
    """
    ...
    def __init__(self):
        super(StudentAgent14, self).__init__()
        self.name = "StudentAgent14"
        self.autoplay = True
        self.dir_map = {
            "u": 0,
            "r": 1,
    ...
    def step(self, chess_board, my_pos, adv_pos, max_step):
        ...
        for i in range(1, 20):
            try:
                ...
                print("agent 14", i, time.time() - self.start_time) #, self.time0, self.time1, self.time2, self.time3, self.time4)
